...
{
    public const string _rootDir = "ULua"; 
    public static string luaDir = Application.dataPath + "/" + _rootDir + "/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/" + _rootDir + "/ToLua/Lua";        //tolua lua文件目录
    ...
    public static string luaResDir = string.Format("{0}/{1}" + "/" + _rootDir + "/Lua", Application.persistentDataPath, osDir);      //手机运行时lua文件下载目录    
